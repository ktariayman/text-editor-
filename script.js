 ...
 */
 function updateText(){
  ...
  function makeBold(elem){
    ...
    // if(FormattedText.classList.contains('bold')){
    //   FormattedText.classList.remove('bold');
    // }else{
    //   FormattedText.classList.add('bold');
  }
  ...
  function makeItalic(elem){
    ...
    // let FormattedText = document.getElementById("text-output");
    // if(FormattedText.classList.contains('italic')){
    //   FormattedText.classList.remove('italic');
    // }else{
    //   FormattedText.classList.add('italic');
    }
